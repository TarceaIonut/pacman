...
CYCLES_PER_CELL_PACMAN:int = 5 #amound of draw() calls for pacman to go from a cell to an other (1 / speed)
CYCLES_PER_CELL_GHOST:int = 6 #amound of draw() calls for gosts to go from a cell to an other (1 / speed)

SMALL_POINT_TO_CELL:float = 6
BIG_POINT_TO_CELL:float = 1
CHERRY_TO_CELL:float = 1

CHERRY_ID:int = 10

POWERED_UP_TIME:int = 100
